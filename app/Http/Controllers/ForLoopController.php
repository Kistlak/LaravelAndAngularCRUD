...
{
    public function ForLoopPage(){
        return view('ForLoop');
    }

    public function CountFromNumbers(Request $request){

        $Number = $request->input('num');

        return $this->LoopTheInputsPage($Number);

//        dd($Number);
    }

    public function LoopTheInputsPage($Number){

        return view('Looping')->with('LoopingTime',$Number);
    ...
    public function FormWithJsonPage()
    {
        ...
        return view("FormWithJson",compact('AllTheData'));
    }
